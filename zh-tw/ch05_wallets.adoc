...
表格 pass:[<a data-type="xref" href="#bip39_128_no_pass"
...
data-xrefstyle="select: labelnumber">#bip39_256_no_pass</a>] 顯示了一些恢復碼及其產生的((("key-stretching functions", startref="key-stretch")))種子範例。
